...
public class GameSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case GamePackage.HUMAN_PLAYER: {
			HumanPlayer humanPlayer = (HumanPlayer) theEObject;
			T result = caseHumanPlayer(humanPlayer);
			if (result == null)
				result = casePlayer(humanPlayer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GamePackage.RANDOM_PLAYER: {
			RandomPlayer randomPlayer = (RandomPlayer) theEObject;
			T result = caseRandomPlayer(randomPlayer);
			if (result == null)
				result = casePlayer(randomPlayer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GamePackage.AI_PLAYER: {
			AIPlayer aiPlayer = (AIPlayer) theEObject;
			T result = caseAIPlayer(aiPlayer);
			if (result == null)
				result = casePlayer(aiPlayer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Human Player</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Human Player</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHumanPlayer(HumanPlayer object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Random Player</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Random Player</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRandomPlayer(RandomPlayer object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>AI Player</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>AI Player</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAIPlayer(AIPlayer object) {
		return null;
	}
