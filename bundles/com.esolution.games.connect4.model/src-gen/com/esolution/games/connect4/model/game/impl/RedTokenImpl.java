...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Red Token</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.esolution.games.connect4.model.game.impl.RedTokenImpl#getSquare <em>Square</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RedTokenImpl extends MinimalEObjectImpl.Container implements RedToken {
	/**
	...
	protected EClass eStaticClass() {
		return GamePackage.Literals.RED_TOKEN;
	}
		...
		if (square != null && square.eIsProxy()) {
			...
			if (square != oldSquare) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GamePackage.RED_TOKEN__SQUARE, oldSquare,
							square));
			}
		}
		return square;
	...
	public NotificationChain basicSetSquare(Square newSquare, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GamePackage.RED_TOKEN__SQUARE, oldSquare, newSquare);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSquare(Square newSquare) {
		if (newSquare != square) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.RED_TOKEN__SQUARE, newSquare, newSquare));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GamePackage.RED_TOKEN__SQUARE:
			if (square != null)
				msgs = ((InternalEObject) square).eInverseRemove(this, GamePackage.SQUARE__TOKEN, Square.class, msgs);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GamePackage.RED_TOKEN___GET_SIDE:
			return getSide();
		case GamePackage.RED_TOKEN___GET_OPPOSITE_SIDE:
			return getOppositeSide();
		case GamePackage.RED_TOKEN___GET_IMAGE_FILE:
			return getImageFile();
		}
